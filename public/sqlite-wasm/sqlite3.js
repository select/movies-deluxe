...
var sqlite3InitModule = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    function assignWasmExports(wasmExports) {
      ...
      _sqlite3changeset_apply_v3_strm = Module['_sqlite3changeset_apply_v3_strm'] =
    ...
    Module.runSQLite3PostLoadInit = function (
      ...
      globalThis.sqlite3ApiBootstrap = async function sqlite3ApiBootstrap(
        ...
        return sqlite3.asyncPostInit().then(s => {
          sqlite3InitScriptInfo.debugModule('sqlite3.asyncPostInit() complete', sqlite3)
      ...
      globalThis.Jaccwabyt = function StructBinderFactory(config) {
        ...
        const makeMemberWrapper = function f(ctor, name, descr) {
          ...
          prop.get = function () {
            ...
            let rc = new DataView(heap().buffer, Number(this.pointer) + descr.offset, descr.sizeof)[
              f._.getters[sigGlyph]
            ](0, isLittleEndian)
            ...
            const kvvfsImpls = {
              xRead: (zClass, zKey, zBuf, nBuf) => {
                ...
                try {
                  ...
                  wasm.heap8u().copyWithin(Number(zBuf), Number(zV), wasm.ptr.addn(zV, nBuf, -1))
      ...
      try {
        ...
        bootstrapConfig.wasmPtrIR =
          'number' === typeof bootstrapConfig.exports.sqlite3_libversion() ? 'i32' : 'i64'
