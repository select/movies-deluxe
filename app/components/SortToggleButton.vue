  ...
  <div class="flex w-full rounded-full border border-theme-border/50 overflow-hidden">
    <button
      ...
      :class="{
        ...
        'bg-theme-surface text-theme-text-muted hover:bg-theme-selection': !isOptionAActive
      }"
      @click="$emit('select', optionA)"
    >
      <div
        class="text-sm"
        :class="[icon, isOptionAActive ? 'text-white' : 'text-theme-text-muted']"
      />
    ...
    <button
      ...
      :class="{
        ...
        'bg-theme-surface text-theme-text-muted hover:bg-theme-selection': !isOptionBActive
      }"
